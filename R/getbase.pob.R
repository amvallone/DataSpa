...
#'
#' @return a file saved in \code{data_poblacion} folder into the working directory wtih default name \code{pob_q_year_provincia.xls}.If \code{extr} is TRUE, the file will be saved as \code{pob_e_year_provincia.xls}. In case of \code{anual} is TRUE the file is saved by the name \code{pob_a_year_provincia.xls}
#' 
#' @examples
...
getbase.pob<-function(year,provincia,extr=FALSE,anual=FALSE){
		...
		file<-paste(getwd(),"/data_poblacion/",paste("pob",e,year,provincia,sep="_"),".xls",sep="")
		...
		n<-p[prov]
		url<-paste("http://www.ine.es/jaxi/files/_px/es/xls/t20/e245/p05/a",year,"/l0/000",n,"00",q,".px?nocab=1",sep="")
